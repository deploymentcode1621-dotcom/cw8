...
const T = {
  ...
  primary:     "#7c4f2a",
  primaryLight:"#b07848",
  primaryMuted:"rgba(124,79,42,0.10)",
  primaryBorder:"rgba(124,79,42,0.22)",

  // Accent — medium grey-brown
  accent:      "#6b5b4e",
  accentLight: "#8c7568",
  accentMuted: "rgba(107,91,78,0.10)",
  accentBorder:"rgba(107,91,78,0.25)",

  // Section backgrounds — warm tinted
  bgLavender:  "#f5f0eb",   // warm parchment
  bgMint:      "#f2ede8",   // warm grey-beige
  bgPeach:     "#fdf6f0",   // soft warm white
  bgSky:       "#ede8e3",   // cool grey-beige
  bgYellow:    "#faf5ef",   // ivory
  bgDark:      "#2c1f14",   // deep espresso

  // Card accent colors — brown & grey tones
  cardRed:     "#9e3a2b",   // burnt sienna
  cardOrange:  "#a05c2a",   // warm cognac
  cardYellow:  "#8a6d3b",   // golden brown
  cardGreen:   "#5a7a52",   // sage green (neutral earthy)
  cardTeal:    "#4a6a6e",   // slate blue-grey
  cardBlue:    "#4a5e72",   // steel grey-blue
  cardPurple:  "#6e5470",   // muted mauve
  cardPink:    "#8c4a5a",   // dusty rose

  // Gradients
  gradPurple:  "linear-gradient(135deg, #f5f0eb 0%, #ede4d8 100%)",
  gradGreen:   "linear-gradient(135deg, #f0ebe5 0%, #e4dbd2 100%)",
  gradBlue:    "linear-gradient(135deg, #ede8e3 0%, #e0d8d0 100%)",
  gradDark:    "linear-gradient(135deg, #2c1f14 0%, #4a3020 100%)",
  gradAccent:  "linear-gradient(135deg, #7c4f2a 0%, #a07040 100%)",
  gradPrimary: "linear-gradient(135deg, #7c4f2a 0%, #5a3820 100%)",
};

// ── FONT CHANGE: Plus Jakarta Sans for display/headings, Inter for body ──
...
export default function AboutPage() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,700&family=Inter:wght@300;400;500;600;700&display=swap');
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        @keyframes pulse{0%{box-shadow:0 0 0 0 rgba(124,79,42,0.6)}70%{box-shadow:0 0 0 10px rgba(124,79,42,0)}100%{box-shadow:0 0 0 0 rgba(124,79,42,0)}}
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(120deg, rgba(124,79,42,0.35) 0%, transparent 50%)", mixBlendMode: "screen" }} />
        <div style={{ position: "absolute", bottom: 0, right: 0, width: "45%", height: "60%", background: "radial-gradient(ellipse at bottom right, rgba(90,56,32,0.28) 0%, transparent 70%)" }} />
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, zIndex: 15, background: "linear-gradient(90deg, #7c4f2a, #a07040, #8a6d3b, #6b5b4e, #4a6a6e, #6e5470, #9e3a2b)" }} />
        ...
        <div className="hero-floats" style={{
          ...
          {[
            ...
            <div key={c.l} className={`c${i}`} style={{
              ...
              <div>
                <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.3rem", fontWeight: 700, color: "#fff", lineHeight: 1 }}>{c.n}</div>
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: 1280, margin: "0 auto", width: "100%", padding: "0 clamp(20px,4vw,52px) 96px" }}>
          ...
          <div style={{ maxWidth: 620 }}>
            <div className="a0" style={{
              ...
              background: "rgba(124,79,42,0.22)", border: "1px solid rgba(176,120,72,0.4)",
            ...
            <h1 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(2.8rem,6vw,5.2rem)", fontWeight: 800, lineHeight: 1.07, color: "#fff", letterSpacing: "-0.025em", marginBottom: 6 }}>
              ...
              <span className="a2" style={{
                ...
                background: "linear-gradient(90deg, #d4a574, #c9956a, #e8c4a0)",
                WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
              }}>Excellence.</span>
            </h1>

            <div className="a3" style={{ width: 64, height: 3, margin: "22px 0", background: "linear-gradient(90deg, #7c4f2a, #a07040, transparent)", borderRadius: 4 }} />
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 clamp(20px,4vw,52px)" }}>
          <div className="about-split" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(36px,6vw,80px)", alignItems: "center" }}>
            <div style={{ position: "relative", borderRadius: 24, overflow: "hidden", aspectRatio: "4/3.2" }}>
              ...
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, zIndex: 3, background: "linear-gradient(90deg, #7c4f2a, #a07040, #8a6d3b, #6b5b4e)" }} />
              <div style={{
                ...
                <div>
                  <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.25rem", fontWeight: 700, color: T.darkText, lineHeight: 1.1 }}>25+ Years</div>
            ...
            <div>
              ...
              <h2 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(1.8rem,3.2vw,2.6rem)", fontWeight: 700, color: T.darkText, letterSpacing: "-0.018em", lineHeight: 1.15, marginBottom: 22 }}>
              ...
              <div style={{ borderLeft: `3px solid ${T.primary}`, padding: "14px 20px", marginBottom: 22, background: T.primaryMuted, borderRadius: "0 12px 12px 0" }}>
                <p style={{ fontFamily: FONT_DISPLAY, fontStyle: "italic", fontSize: "1rem", color: T.darkText, lineHeight: 1.65, margin: 0, fontWeight: 400 }}>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginTop: 28 }}>
                {[
                  ...
                  >
                    <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.6rem", fontWeight: 700, color: s.c, lineHeight: 1 }}>{s.n}</div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 clamp(20px,4vw,52px)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22 }} className="about-split">
            {[
              ...
              { Icon: Icons.Globe, title: "Our Vision",  body: "To become the most trusted multispeciality hospital in Maharashtra — recognised for clinical excellence, continuous innovation, and outstanding patient satisfaction across every touchpoint.", tag: "Where We're Going", color: T.cardPurple, grad: "linear-gradient(135deg, #5a3820 0%, #6e5470 100%)" },
            ].map(c => (
              <div key={c.title} style={{
                ...
                <h3 style={{ fontFamily: FONT_DISPLAY, fontSize: "1.8rem", fontWeight: 700, color: "#fff", marginBottom: 14 }}>{c.title}</h3>
          ...
          <div className="why-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {WHY_CARDS.map(({ Icon, title, desc, color, bg }) => (
              <div key={title} className="why-card" style={{
                ...
                <h3 style={{ fontFamily: FONT_DISPLAY, fontSize: "1.12rem", fontWeight: 700, color: T.darkText, marginBottom: 10 }}>{title}</h3>
              ...
              return (
                <div key={item.year} style={{
                  ...
                  >
                    ...
                    <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.05rem", fontWeight: 700, color: T.darkText, marginBottom: 6 }}>{item.title}</div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 clamp(20px,4vw,52px)" }}>
          ...
          <div className="team-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 20 }}>
            {TEAM.map((doc, i) => {
              ...
              const bgs = ["#f0e8e0", "#ede8e3", "#f5ede5", "#ede5ed"];
              return (
                <div key={doc.name} className="team-card" style={{
                  ...
                  <div style={{ height: 130, background: bgs[i % bgs.length], display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                    ...
                    <div style={{ width: 68, height: 68, borderRadius: "50%", background: T.white, border: `2.5px solid ${doc.color}`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: FONT_DISPLAY, fontSize: "1.35rem", fontWeight: 700, color: doc.color, zIndex: 1, boxShadow: `0 4px 14px ${doc.color}30` }}>{initials}</div>
                  </div>
                  <div style={{ padding: "6px 20px 26px", textAlign: "center" }}>
                    <div style={{ fontFamily: FONT_DISPLAY, fontSize: "0.98rem", fontWeight: 700, color: T.darkText, marginBottom: 4 }}>{doc.name}</div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 clamp(20px,4vw,52px)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "2rem" }}>
            <div>
              ...
              <h2 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(1.3rem,2.5vw,1.8rem)", fontWeight: 700, color: T.darkText }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 20px", border: `1.5px solid ${T.cardGreen}30`, borderRadius: 50, background: "#ebfbee" }}>
              ...
              <div>
                <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.1rem", fontWeight: 700, color: T.darkText, lineHeight: 1 }}>24 / 7</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16 }} className="about-split">
            <a href={`tel:${EMERGENCY_INFO.phone}`} className="ec-card" style={{
              ...
              <div>
                ...
                <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.25rem", fontWeight: 700, color: T.darkText, lineHeight: 1.1 }}>{EMERGENCY_INFO.phone}</div>
            ...
            <a href={`tel:${EMERGENCY_INFO.ambulance}`} className="ec-card" style={{
              ...
              <div>
                ...
                <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.25rem", fontWeight: 700, color: T.darkText, lineHeight: 1.1 }}>{EMERGENCY_INFO.ambulance}</div>
          ...
          <div className="accred-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
            {ACCREDITATIONS.map(a => (
              <div key={a.title} className="accred-card" style={{
                ...
                <div style={{ fontFamily: FONT_DISPLAY, fontSize: "1.2rem", fontWeight: 700, color: T.darkText, marginBottom: 10 }}>{a.title}</div>
      ...
      <section style={{ padding: "100px 24px", textAlign: "center", background: T.gradDark, position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "linear-gradient(90deg, #7c4f2a, #a07040, #8a6d3b, #6b5b4e, #4a6a6e, #6e5470, #9e3a2b)" }} />
        ...
        <div style={{ position: "absolute", top: "20%", left: "10%", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(124,79,42,0.22) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", top: "20%", right: "10%", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(107,91,78,0.22) 0%, transparent 70%)", pointerEvents: "none" }} />

        <div style={{ position: "relative", zIndex: 1, maxWidth: 580, margin: "0 auto" }}>
          <Pill label="Ready to Get Started?" color={T.primaryLight} bg="rgba(116,143,252,0.15)" />
          <h2 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(2rem,3.8vw,2.9rem)", fontWeight: 700, color: "#fff", marginBottom: 16, lineHeight: 1.15 }}>
            Your Health Journey<br />
            <em style={{ fontStyle: "italic", background: "linear-gradient(90deg, #d4a574, #c9956a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Begins Here</em>
          </h2>

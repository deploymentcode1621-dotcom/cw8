  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        medical: ["var(--font-nunito)", "system-ui", "sans-serif"],
      },
      animation: {
      ...
      backgroundImage: {
        "hero-pattern":
          "radial-gradient(ellipse at 30% 50%, rgba(59,130,246,0.15) 0%, transparent 60%), radial-gradient(ellipse at 70% 20%, rgba(34,197,94,0.1) 0%, transparent 50%)",
        "section-pattern":
